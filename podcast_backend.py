...
def get_podcast_summary(podcast_transcript):
  ...
  instructPrompt = "Summarize the podcast for a technology enthusiast under 100 words:"
...
def get_podcast_guest(podcast_transcript):
  ...
  guest_info = {}
  guest_info['podcast_guest'] = podcast_guest
  guest_info['podcast_guest_org'] = podcast_guest_org
  guest_info['podcast_guest_title'] = podcast_guest_title
  return guest_info
...
def get_podcast_highlights(podcast_transcript):
  ...
  instructPrompt = "Give the key moments and highligts in the form of bullet points: "
  request = instructPrompt + podcast_transcript
  chatOutput = openai.ChatCompletion.create(model="gpt-3.5-turbo-16k",
                                            messages=[{"role": "system", "content": "You are a helpful assistant."},
                                                      {"role": "user", "content": request}
...
def process_podcast(url, path):
  ...
  output['podcast_guest'] = podcast_guest['podcast_guest']
  output['podcast_guest_org'] = podcast_guest['podcast_guest_org']
  output['podcast_guest_title'] = podcast_guest['podcast_guest_title']
